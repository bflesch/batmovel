...
import com.example.batmovel.MainActivity.CaronasFragment.MyAdapter;
...
public class MainActivity extends Activity {
	...
	public static class CaronasFragment extends ListFragment {
		...
		public class Balacobaco {
			...
			public Balacobaco(MyAdapter adapter) {
				this.adapter = adapter;
				UpdateTask updator = new UpdateTask();
				new Timer().scheduleAtFixedRate(updator, 0, 1000*10 /*miliseconds*/);
			}
